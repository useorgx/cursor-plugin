...
Use these repo-local scripts when configuring the Codex cloud environment for `useorgx/cursor-plugin`.
...
- No OrgX API secrets are required for plugin bundle verification.
